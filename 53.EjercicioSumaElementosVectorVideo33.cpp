// Ejercicio: Escribe un programa que defina un vector de números y calcule si existe algún número en el vector cuyo 
//valor equivale a la suma del resto de números del vector. video 33
#include<iostream>
#include<conio.h>
using namespace std; 
int main(){
